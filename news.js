    ...
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="flex items-center mt-4">
            ...
            <div
                ...
                <button
                    class="${newsData.data[0].others_info.is_todays_pick ? 'block' : 'hidden'} cursor-default text-white text-sm bg-blue-600 hover:bg-blue-600 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-md px-3 py-2 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-600 dark:focus:ring-blue-800 mr-1">Today’s
                    Pick</button>
                <button
                    class="${newsData.data[0].others_info.is_trending ? 'block' : 'hidden'} cursor-default text-white text-sm bg-blue-600 hover:bg-blue-600 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-md px-3 py-2 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-600 dark:focus:ring-blue-800">Trending</button>
                </div>
            </div>
        </div>
